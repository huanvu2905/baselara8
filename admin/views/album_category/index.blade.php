...
@section('title', __('Quản lý danh mục album'))
...
<div class="row">
    <div class="card border border-primary">
        <div class="card-body">
            <h4 class="card-title">Quản lý danh mục album</h4>
            <a href="{{ route('admin.album_category.create') }}" class="btn btn-primary waves-effect waves-light">
                ...
                <table class="table mb-0">
                    ...
                    <tbody>
                        ...
                        <td>{{ $albumCategory->id }}</td>
                            <td><a href="javascript:;">{{ $albumCategory->name }}</a></td>
                            <td>{{ $albumCategory->created_at}}</td>
                            <td><span class="label label-success">{{ $albumCategory->parent->name }}</span></td>
                            <td>{{ $albumCategory->slug }}</td>
                            <td>{{ ($albumCategory->active==1) ? 'Active' : 'Not Active' }}</td>
                                ...
                                <div>
                                    <div class="btn-group btn-group-example" role="group">
                                        <a 
                                            ...
                                            href="{{ route('admin.album_category.edit', $albumCategory->id) }}"
                                        >
                                        ...
                                        <button
                                            ...
                                            data-url="{{ route('admin.album_category.destroy', $albumCategory->id) }}"
                                        >
