...
<div class="row">
    <div class="col-lg-9">
        <div class="card border border-primary">
            <div class="card-body">
                <h4 class="card-title mb-4">Thêm mới danh mục bài viết</h4>
                <form method="POST" action="{{ route('admin.post_category.update', $postCategory->id) }}" >
                    @csrf
                    <div class="row mb-4">
                        ...
                        <div class="col-lg-8">
                            <input 
                                ...
                                name="name" type="text" 
                                class="form-control" 
                                value="{{ old('name', \Arr::get($postCategory, 'name')) }}" 
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <input 
                                                ...
                                                class="form-control" 
                                                maxlength="512"
                                                value="{{ old('meta_tile', \Arr::get($postCategory, 'meta_title')) }}"
                                            >
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <input 
                                                ...
                                                class="form-control" 
                                                maxlength="512"
                                                value="{{ old('meta_keyword', \Arr::get($postCategory, 'meta_keyword')) }}"
                                            >
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <textarea 
                                                ...
                                                rows="5" 
                                                maxlength="512"
                                            >{{ nl2br_e(old('meta_description', \Arr::get($postCategory, 'meta_description'))) }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-form-label col-lg-8">
                                <div class="form-check form-switch mb-3" dir="ltr">
                                    <input 
                                        ...
                                        name="active" 
                                        value="1" 
                                        {{ \Arr::get($postCategory, 'active') == 1 ? 'checked' : '' }}
                                    >
