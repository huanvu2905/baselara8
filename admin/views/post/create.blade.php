                                    ...
                                    <div class="tab-content p-1 text-muted">
                                        <div class="tab-pane active" id="viDesc" role="tabpanel">
                                            <textarea 
                                                ...
                                                name="description" 
                                                rows="5" 
                                                maxlength="512">{{ nl2br_e(old('description')) }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="tab-content p-3 text-muted">
                                        <div class="tab-pane active" id="viContent" role="tabpanel">
                                            <textarea id="vi-area" class="mi-area" name="content">{{ htmlspecialchars_decode(old('content')) }}</textarea>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        tinymce.init({
            ...
            images_upload_base_path: '/public/upload/content',
